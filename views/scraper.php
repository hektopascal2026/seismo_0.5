...
<body>
    <div class="container">
        ...
        <div class="latest-entries-section module-section-spaced" style="padding-bottom:0;">
            <form method="post" action="<?= e($basePath) ?>/index.php?action=refresh_scraper_sources" class="admin-inline-form" style="flex-wrap: wrap; align-items: center; gap: 0.75rem 1rem;">
                <?= $csrfField ?>
                <input type="hidden" name="return_view" value="<?= e($view) ?>">
                <button type="submit" class="btn btn-primary">Refresh scraper sources</button>
                <span class="admin-intro" style="margin:0;">Runs <code>core:scraper</code> only.</span>
            </form>
        </div>
        <?php endif; ?>
